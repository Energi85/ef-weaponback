...
local hasnobag = false
local me = GetPlayerPed(-1)


Citizen.CreateThread(function(source)
  while true do
    TriggerServerEvent('ef-weaponback:bagcheck', source)
    Wait(2000)
  end
  end)
  ...
  RegisterNetEvent('ef-weaponback:hasnobag')
  AddEventHandler('ef-weaponback:hasnobag', function()
  ...
  RegisterNetEvent('ef-weaponback:hasbag')
  AddEventHandler('ef-weaponback:hasbag', function()
      local player = PlayerPedId()
...
if isMelee then x = 0.078 y = -0.15 z = 0.0 xR = 100.0 yR = 185.0 zR = 92.0 end
